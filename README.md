...
```ts
npm install @apimatic_test/type-pack-sdk@1.2.1
```

For additional package details, see the [Npm page for the @apimatic_test/type-pack-sdk@1.2.1 npm](https://www.npmjs.com/package/@apimatic_test/type-pack-sdk/v/1.2.1).

## Initialize the API Client

**_Note:_** Documentation for the client can be found [here.](https://www.github.com/Syed-Subtain/type-pack-js-sdk/tree/1.2.1/doc/client.md)
...
* [Pet](https://www.github.com/Syed-Subtain/type-pack-js-sdk/tree/1.2.1/doc/controllers/pet.md)
* [Store](https://www.github.com/Syed-Subtain/type-pack-js-sdk/tree/1.2.1/doc/controllers/store.md)
* [User](https://www.github.com/Syed-Subtain/type-pack-js-sdk/tree/1.2.1/doc/controllers/user.md)

## Classes Documentation

* [ApiResponse](https://www.github.com/Syed-Subtain/type-pack-js-sdk/tree/1.2.1/doc/api-response.md)
* [ApiError](https://www.github.com/Syed-Subtain/type-pack-js-sdk/tree/1.2.1/doc/api-error.md)
